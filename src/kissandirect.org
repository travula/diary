...
* Current Scenario and breaking the nexus
  ...
  mango that is determined at a market yard in an auction, the flow chart helps
  in visualizing the actual amount the farmer gets.  An average of Rs. 3 /Kg is
  spent towards costs for harvesting and transporting his produce to the market
  yard.  An additional 10% of x (the price a wholesaler bids in open auction in
  market yard) is paid by the farmer to the agent who facilitates the
  transaction between the farmer and wholesaler at the market yard.  The net
  price that a farmer gets for a kilogram of mango is: x - 3 - x*10/100 =
  0.9x - 3.  From my experience in the last 5 years, x varies anywhere between
  Rs. 7 and Rs. 12 depending on the amount of fruit coming to market yard
  during the peak season (end of April to early June).  This means a farmer
  makes anywhere between Rs. 4 and Rs. 7 a kilo.
...
* Benefits of buying from KISSANDIRECT 
